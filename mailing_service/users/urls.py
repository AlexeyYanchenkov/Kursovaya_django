...
from .views import (
    ...
    EmailConfirmationSentView, ActivationSuccessView, ActivationFailedView, UserLoginView, UserLogoutView,
...
urlpatterns = [
    ...
    path('activation_success/', ActivationSuccessView.as_view(), name='activation_success'),
    path('activation_failed/', ActivationFailedView.as_view(), name='activation_failed'),
